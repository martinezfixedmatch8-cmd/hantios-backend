...
_Generated: 2026-08-05T10:15:54.811Z_
...
Workspace `mcp.json` _(folder: hantios-backend)_

- **c:\Users\CXC\hantios-backend\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\CXC\.claude.json** — _File exists — no servers defined_
